<template>
    <footer class="bg-dark py-12 px-4">
      <div class="container-width">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a href="#" class="text-gray-400 hover:text-primary">AI Interviews</a></li>
              <li><a href="#" class="text-gray-400 hover:text-primary">Resume Analysis</a></li>
              <li><a href="#" class="text-gray-400 hover:text-primary">Practice Tools</a></li>
              <li><a href="#" class="text-gray-400 hover:text-primary">Enterprise</a></li>
            </ul>
          </div>
          <div>
            <h3 class="text-xl font-bold mb-4">Resources</h3>
            <ul class="space-y-2">
              <li><a href="#" class="text-gray-400 hover:text-primary">Interview Tips</a></li>
              <li><a href="#" class="text-gray-400 hover:text-primary">Career Guides</a></li>
              <li><a href="#" class="text-gray-400 hover:text-primary">Success Stories</a></li>
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><a href="#" class="text-gray-400 hover:text-primary">Security</a></li>
